...
public class NetherStatusTask {

    private final SurvivalPlugin survivalPlugin;
    private final WorldsSettings worldsSettings;

    public NetherStatusTask(SurvivalPlugin survivalPlugin, WorldsSettings worldsSettings) {
    ...
    public void scheduleDailyTasks() {
        ...
        new BukkitRunnable() {
            @Override
            public void run() {
                worldsSettings.setNetherJoinStatus(true);
            }
        ...
        new BukkitRunnable() {
            @Override
            public void run() {
                worldsSettings.setNetherJoinStatus(false);
            }
